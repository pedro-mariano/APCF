The Autoencoder Pattern-based Collaborative Filtering (APCF) method is a Recommender System that calculates predictions using subsets of relevant items found by an efficient autoencoder technique, the BinaPs algorithm (Fischer & Vreeken, 2021 - https://doi.org/10.1145/3447548.3467348).
